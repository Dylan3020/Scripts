...
local ESP_Entities = {RushMoving={"Rush",5},AmbushMoving={"Ambush",5},FigureRagdoll={"Figure",7},Shade={"Halt",5},LookmanNew={"Eyes",4},BlitzMoving={"Blitz",5},TrollfaceMoving={"Troll Face",5},BackdoorLookmanNew={"Lookman",7},FigureLibrary={"Figure",7},SeekMoving={"Seek",5.5},Screech={"Screech",2},Snare={"Snare",2},A60Moving={"A-60",10},A120Moving={"A-120",10},JeffTheKillerMoving={"Jeff",5}}
