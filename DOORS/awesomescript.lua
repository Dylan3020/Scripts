...
local ESP_Entities = {RushMoving={"Rush",5},AmbushMoving={"Ambush",5},Grumbo={"Grumble",5},GloombatSwarm={"Gloombat Swarm",5},BackdoorLookman={"Lookman",7},GiggleCeiling={"Giggle",5},BackdoorRush={"Blitz",5},FigureRig={"Figure",7},FigureLibrary={"Figure",7},SeekMovingNewClone={"Seek",5.5},Screech={"Screech",2},Eyes={"Eyes",4},Snare={"Snare",2},A60={"A-60",10},A120={"A-120",10}}
        ...
        for _,Player in pairs(Players:GetPlayers()) do
            local function WasteItem(Item)
                if Item.Parent ~= Character and Item.Parent.Parent ~= LocalPlayer then
                    if ((Item.Name == "Lighter" or Item.Name == "Flashlight") and Item:GetAttribute("Enabled") == false) or Item.Name == "BandagePack" or Item.Name == "Candle" or Item.Name == "BatteryPack" or "LaserPointer" or Item.Name == "Glowsticks" or Item.Name == "Vitamins" then
