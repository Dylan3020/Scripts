...
local Window = Flux:Window("awesome script  ", "Rooms", Color3.new(0,0.8), Enum.KeyCode.RightControl)
...
local ESP_Items = {Lighter={"Lighter",1.5},Lockpick={"Lockpicks",1.5},Vitamins={"Vitamins",1.5},Crucifix={"Crucifix",1.5},CrucifixWall={"Crucifix",1.5},SkeletonKey={"Skeleton Key",1.5},Flashlight={"Flashlight",1.5},GoldPile={"Gold",0.5},Bandage={"Bandage",0.5},Candle={"Candle",1.5},Battery={"Battery",1.5},Shakelight={"Shakelight",1.5}}
local ESP_Entities = {Screech={"Screech",5},RushMoving={"Rush",5},AmbushMoving={"Ambush",5},BackdoorLookmanNew={"Lookman",5},LookmanNew={"Eyes",5},BlitzMoving={"Blitz",5},SeekMoving={"Seek",5.5},Landmine={"Snare",2},A60Moving={"A-60",5},A120Moving={"A-120",5}}
local ESP_Other = {Locker={"Locker",5},CustomMoving={"Custom Entity",5}}
...
Tab2:Toggle("Door ESP","Highlights the door nothing more lol",false,function(Bool)
    DoorESP = Bool
    for _,Object in pairs(workspace:GetDescendants()) do
        if ESP_Door[Object.Name] then
            ApplySettings(Object)
        end
    end
end)
Tab2:Toggle("Objective ESP","Highlights the objectives you have to do.",false,function(Bool)
    ObjectiveESP = Bool
    for _,Object in pairs(workspace:GetDescendants()) do
