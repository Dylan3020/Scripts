...
local EntityName = {"BlitzMoving", "BackdoorLookmanNew", "RushMoving", "AmbushMoving", "Ambush_ModifierMoving", "LookmanNew", "JeffTheKiller", "A60Moving", "A120Moving"}
    ...
    if character then
        ...
        if Toggles.AntiEyes.Value and (workspace:FindFirstChild("Eyes") or workspace:FindFirstChild("BackdoorLookman")) then
            if not isFools then
                ...
                bricks.MotorReplication:FireServer(-649)
            else
