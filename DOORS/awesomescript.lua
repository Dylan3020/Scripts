...
local ESP_Entities = {RushMoving={"Rush",5},AmbushMoving={"Ambush",5},GrumbleRig={"Grumble",5},GloombatSwarm={"Gloombat Swarm",5},BackdoorLookman={"Lookman",7},GiggleCeiling={"Giggle",5},BackdoorRush={"Blitz",5},FigureRig={"Figure",7},FigureLibrary={"Figure",7},SeekMovingNewClone={"Seek",5.5},Screech={"Screech",2},Eyes={"Eyes",4},Snare={"Snare",2},A60={"A-60",10},A120={"A-120",10}}
