...
local EntityName = {"BackdoorRush", "BackdoorLookmanNew", "RushMoving", "AmbushMoving", "BlitzMoving", "TrollfaceMoving", "SeekMoving", "Ambush_ModifierMoving", "Eyes", "Screech", "Halt", "JeffTheKiller", "A60Moving", "A120Moving"}
local SideEntityName = {"FigureRig", "Snare"}
local ShortNames = {
    ["BlitzMoving"] = "Blitz",
...
task.spawn(function()
    ...
    elseif isRooms then
        ...
        function Script.Functions.GetAutoRoomsPathfindingGoal(): BasePart
            local entity = (workspace:FindFirstChild("A60Moving") or workspace:FindFirstChild("A120Moving"))
...
CreditsGroup:AddLabel("US_VK- owner of this dead game")
