...
local DoorRange
local SpoofMotor
local ESP_Items = {KeyObtain={"Key",1.5},GoldPile={"Gold",0.5},Bandage={"Bandage",0.5},ShieldMini={"Small Potion",1.5},ShieldBig={"Big Potion",1.5},HolyGrenade={"Holy Grenade",1.5},LiveHintBook={"Book",1.5},Lighter={"Lighter",1.5},Lockpick={"Lockpicks",1.5},Vitamins={"Vitamins",1.5},Crucifix={"Crucifix",1.5},CrucifixWall={"Crucifix",1.5},SkeletonKey={"Skeleton Key",1.5},Flashlight={"Flashlight",1.5},Candle={"Candle",1.5},LiveBreakerPolePickup={"Fuse",1.5},Shears={"Shears",1.5},Battery={"Battery",1.5},PickupItem={"Paper",1.5},ElectricalKeyObtain={"Electrical Key",1.5},Shakelight={"Shakelight",1.5},Scanner={"iPad",1.5}}
local ESP_Entities = {RushMoving={"Rush",5},AmbushMoving={"Ambush",5},FigureRagdoll={"Figure",7},FigureLibrary={"Figure",7},SeekMoving={"Seek",5.5},Screech={"Screech",2},Eyes={"Eyes",4},Snare={"Snare",2},A60={"A-60",10},A120={"A-120",10},JeffTheKiller={"Jeff",5}}
local ESP_Other = {Door={"Door",5},LeverForGate={"Lever",3}}
...
local function ApplySettings(Object)
    task.spawn(function()
        ...
        if (ESP_Items[Object.Name] or ESP_Entities[Object.Name] or ESP_Other[Object.Name]) and Object.ClassName == "Model" then
            ...
            if Object.Name == "RushMoving" or Object.Name == "JeffTheKiller" or Object.Name == "AmbushMoving" or Object.Name == "Eyes" or Object.Name == "A60" or Object.Name == "A120" then
                for i = 1, 100 do
