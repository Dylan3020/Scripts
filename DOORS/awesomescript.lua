...
local CamLock = RemotesFolder.CamLock
...
local DoorRange
local SpoofMotor
local ESP_Items = {KeyObtain={"Key",1.5},Toolshed_Small={"Toolshed",1.5},Chest_Vine={"Chest Vine",1.5},Compass={"Compass",1.5},GlitchCube={"Glitch Fragment",1.5},LotusHolder={"LotusPetal",1.5},LotusPetalPickup={"LotusPetal",1.5},KeyIron={"Iron Key",1.5},IronKeyForCrypt={"Iron Key",1.5},StardustPickup={"Stardust",1.5},LanternLitItem={"Lantern",1.5},Lantern={"Lantern",1.5},Smoothie={"Smoothie",1.5},StarVial={"Star Vial",1.5},Bandage={"Bandage",1.5},GoldPile={"Gold",1.5},LiveHintBook={"Book",1.5},FuseObtain={"Fuse",1.5},Bulklight={"Bulk Light",1.5},Straplight={"Strap Light",1.5},BandagePack={"Bandage Pack",1.5},Lighter={"Lighter",1.5},Glowsticks={"Glowstick",1.5},BatteryPack={"Battery Pack",1.5},LaserPointer={"Laser Point",1.5},Lockpick={"Lockpicks",1.5},Vitamins={"Vitamins",1.5},Crucifix={"Crucifix",1.5},CrucifixWall={"Crucifix",1.5},SkeletonKey={"Skeleton Key",1.5},Flashlight={"Flashlight",1.5},Candle={"Candle",1.5},LiveBreakerPolePickup={"Fuse",1.5},Shears={"Shears",1.5},Battery={"Battery",1.5},PickupItem={"Paper",1.5},ElectricalKeyObtain={"Electrical Key",1.5},Shakelight={"Shakelight",1.5},Scanner={"iPad",1.5}}
local ESP_Entities = {RushMoving={"Rush",5},AmbushMoving={"Ambush",5},Death={"Ripper",5},RushCounterpart={"Cease",5},A-60={"A-60 Multimonster",10},ReboundMoving={"Rebound",5},Silence={"Silence",5},monster2={"A-200",5},HideEntityOnSpot={"Hide",5},LiveEntityBramble={"Bramble",5},MandrakeLive={"Mandrake",5},MonumentEntity={"Monument",5},Groundskeeper={"Groundskeeper",5},GrumbleRig={"Grumble",5},GloombatSwarm={"Gloombat Swarm",5},BackdoorLookman={"Lookman",7},GiggleCeiling={"Giggle",5},BackdoorRush={"Blitz",5},FigureRig={"Figure",7},FigureLibrary={"Figure",7},SeekMovingNewClone={"Seek",5.5},Screech={"Screech",2},Eyes={"Eyes",4},A60={"A-60",10},A120={"A-120",10}}
local ESP_Other = {Door={"Door",8},TimerLever={"Timer Lever",3},VineGuillotine={"Vine Guillotine",3},CringlePresent={"Cringle Present",3},GuideHighlight={"Guiding Light",3},WaterPump={"Wheel Pump",5},MinesGenerator={"Generator",3},WoodenArrowSign_Left={"Go Left Minecart",3},WoodenArrowSign_Right={"Go Right Minecart",3},MinesAnchor={"Lever",3},LeverForGate={"Lever",3}}
local MainFrame = MainUI.MainFrame
local GameData = ReplicatedStorage.GameData
local LatestRoom = GameData.LatestRoom
local Floor = GameData.Floor
local OldEnabled = {}
local Module_Events = require(ModulesClient.Module_Events)
...
RemotesFolder.UseEnemyModule.OnClientEvent:Connect(function(Entity,x,...)
                    ...
                    if Bool then
                        ...
                        if IsValid[1] == "Door" then
                            ...
                            if Floor.Value == "Rooms" then
                                ...
                                local OldString = workspace.CurrentRooms[tonumber(Object.Parent.Name) + 1]:GetAttribute("OriginalName")
                                local NewString = ""
                                RoomName = " (" .. NewString .. ")"
                            end
...
RemotesFolder.A90.OnClientEvent:Connect(function()
        ...
        for _,Player in pairs(Players:GetPlayers()) do
            local function WasteItem(Item)
                if Item.Parent ~= Character and Item.Parent.Parent ~= LocalPlayer then
                    if ((Item.Name == "Lighter" or Item.Name == "LaserPointer" or  Item.Name == "Flashlight") and Item:GetAttribute("Enabled") == false) or Item.Name == "BandagePack" or Item.Name == "BatteryPack" or Item.Name == "Glowsticks" or Item.Name == "Vitamins" then
