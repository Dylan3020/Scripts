...
local ESP_Other = {Door={"Door",5},TimerLever={"Timer Lever",3},CringlePresent={"Cringle Present",3},GuideHighlight={"Guiding Light",3},WaterPump={"Pump Wheel",3},MinesGenerator={"Generator",3},WoodenArrowSign_Left={"Go Left Minecart",3},WoodenArrowSign_Right={"Go Right Minecart",3},MinesAnchor={"Lever",3},LeverForGate={"Lever",3}}
